...
(function () {
    ...
    app.factory("soapService", ['$q', '$http', function ($q, $http) {
        // Soap WSDL url
        ...
        function asyncGetFieldCheckPermitsByUserUsingWinJS() {
        ...
        // FUNCTION: call BPM web service to get instances by loginName, using jQuery AJAX method
        function asyncGetFieldCheckPermitsByUserUsingJQuery() {
        ...
        // FUNCTION: call BPM web service to get instances by loginName, using jQuery AJAX method
        function asyncGetFieldCheckPermitsByUserUsingAngular() {          
            return $q(function (resolve, reject) {
                var url = 'https://bpm856pc.corp.coutureconsulting.com:9443/teamworks/webservices/PNMS/PNMUntetheredServices.tws?WSDL';
                function successCallback(response) {
                    console.log("successfully call soap service with angular $http");
                    console.log(response);
                    var $instanceIdNode = angular.element(response.data).find("instanceIDs");
                    var $items = $instanceIdNode.find("item");
                    var instanceIDs = [];
                    for (var i = 0; i < $items.length; i++) {
                        instanceIDs.push($items[i].innerHTML);
                ...
                function errorCallback(error) {
                    console.log("failed to call soap service with angular $http");
                    reject("error");
                }
                var data =
                      '<Envelope xmlns="http://www.w3.org/2003/05/soap-envelope">'
        ...
        return {
            ...
            getFieldCheckPermitsByUserUsingJquery: asyncGetFieldCheckPermitsByUserUsingJQuery,
            getFieldCheckPermitsByUserUsingWinJS: asyncGetFieldCheckPermitsByUserUsingWinJS,
            getFieldCheckPermitsByUserUsingAngular: asyncGetFieldCheckPermitsByUserUsingAngular,
